<template>
  <div class="container">
        ...
        <tr v-for="post in filteredPosts" :key="post.id">
          ...
          <td v-if="showActions">
            <button @click="editPost(post.id)">
              ...
              >
                <path
                  d="M13.586 2.586a2 2 0 0 1 2.828 0l4 4a2 2 0 0 1 0 2.828l-11.5 11.5a1 1 0 0 1-.293.195l-6 2a1 1 0 0 1-1.281-1.282l2-6a1 1 0 0 1 .195-.293l11.5-11.5zM15 5.414L5.414 15H5v.414L4.414 17H5v-.414l9.586-9.586L15 5.414zM16 4l-1.414 1.414L17.172 8 18.586 6.586 16 4zM5.172 15L4 16.172V17h.828L5.172 15z"
                />
              </svg>
            </button>
    ...
    <span v-if="!filteredPosts.length">No posts found 😥</span>
  </div>
</template>
